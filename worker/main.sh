...
sudo -H --preserve-env=API_BASE_URL --preserve-env=API_AUTH_TOKEN --preserve-env=API_VERIFY_SSL --preserve-env=API_POLLING_INTERVAL -iu worker bash -c "python3 /home/worker/worker.py"